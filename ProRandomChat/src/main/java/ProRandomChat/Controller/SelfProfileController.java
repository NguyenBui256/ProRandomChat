...
public class SelfProfileController {
    ...
    @FXML
    protected Button editBtn, saveBtn, chooseBtn;
    @FXML
    protected TextField userName, userLocation, userFullname;
    @FXML
    protected Label userAge, userGender, userAvatarPath;
    @FXML
    ...
    public void save(ActionEvent event) throws IOException, ClassNotFoundException {
        ...
        update.setUserAvatarPath(userAvatarPath.getText());
    ...
    public void saveSuccess(User user) throws IOException {
        ...
        alert.show();
        setUser(user, mainController, oos);
