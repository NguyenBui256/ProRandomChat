...
//
    ...
    public void changeGenderCriteria(String gender) throws IOException {
        ...
        System.out.println(sender.getGenderCriteria());
...
//    }
    ...
    public void connectToNewUserFirst() throws IOException {
        textHistory.setText("");
        textTyping.setText("");
    ...
    public void connectToNewUserLater() throws IOException {
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
    ...
    public void setWaitScreen() {
        addFriendBtn.setVisible(false);
        viewBtn.setVisible(false);
        coverLayer.setText("Đang kết nối...");
        coverLayer.setVisible(true);
    }
