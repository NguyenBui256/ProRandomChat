...
//                    if(requestContent.equals("#NewUser")) {ServerAddNewUser((RequestFromUser) object);}
    ...
    public void ServerChangeUserOnline(RequestFromUser object) {
        ChatServer.userMap.get(object.user.getUserName()).status = false;
    }

    public void ServerKill(RequestFromUser object) {
        if(object.user != null)
        {
    ...
    public void ServerLogout(RequestFromUser object) {
        ChatServer.users.remove(object.user.getUserName());
        ChatServer.userMap.remove(object.user.getUserName());
        System.out.println(object.user.getUserName() + " logout!");
    }

    public void ServerAddSignup(RequestFromUser object) throws IOException {
    ...
    public void ServerAddLogin(RequestFromUser object) throws IOException {
    ...
    public void ServerUpdateGenderCriteria(RequestFromUser object) {
        ChatServer.userMap.get(object.user.getUserName()).setGenderCriteria(object.getMessage());
        System.out.println(object.user.getUserName() + " GDC Updated to " +
                ChatServer.userMap.get(object.user.getUserName()).getGenderCriteria());
    }

    public void ServerUpdateUserInfo(RequestFromUser object) throws IOException, ClassNotFoundException {
    ...
    public void ServerRemove(RequestFromUser object) throws IOException {
    ...
    public void ServerSendMessage(RequestFromUser object) throws IOException {
...
//          System.out.println("User passed");
    ...
    public void ServerChangeUserFirst(RequestFromUser object) throws IOException {
        ChatServer.userMap.get(object.user.getUserName()).status = false;
    ...
    public void ServerChangeUserLater(RequestFromUser object) throws IOException {
        ChatServer.userMap.get(object.user.getUserName()).status = false;
    ...
    public void ServerSendPartner(RequestFromUser object) throws IOException {
...
//            System.out.println(user.getUserName() + " " + user.status + " " + user.userPartnerName);
    ...
    public boolean isSuitable(User requestedUser, User user) {
        if(requestedUser.getGenderCriteria().equals("All") && user.getGenderCriteria().equals("All")) return true;
        else {
            if((user.getUserGender().equals(requestedUser.getGenderCriteria()) && user.getGenderCriteria().equals("All"))
            || (requestedUser.getUserGender().equals(user.getGenderCriteria()) || requestedUser.getGenderCriteria().equals("All")))
            {return true;}
        }
        return false;
    }

    public void ServerSendProfile(RequestFromUser object) throws IOException {
