...
import ProRandomChat.Controller.IOSystem;
import ProRandomChat.Controller.LoginController;
import ProRandomChat.Controller.UserManager;
...
public class AppStarter extends Application {
    ...
    public void start(Stage stage) throws IOException, ClassNotFoundException {
        FXMLLoader fxmlLoader = new FXMLLoader(AppStarter.class.getResource("/FMXL/loginForm.fxml"));
